...
npm run dev</code></pre>
        ...
        <p class="text-lg mb-4">Navigate to <i class="bg-highlight px-2 py-1 rounded-border not-italic text-base">http://localhost:5174/</i> to view the application in your local environment.</p>
